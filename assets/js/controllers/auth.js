    ...
    controller.queryFbAPI('/me', function(response) {
      ...
      controller.queryFbAPI('/me/friends', function(response) {
        ...
        response.data.forEach(function(friend, index) {
          ...
          friendList.innerHTML += '<li class="send_mail" onclick="App.Controller.user.sendMail({ subject:\'Einladungsmail\', from:\'phovec@nucular-bacon.com\', to:\''+friend.id+'@facebook.com\', text:\''+invitationText+'\', html:\'<b>'+invitationText+'</b>\'})"> Sende E-Mail an ' + friend.name + '</li>';
